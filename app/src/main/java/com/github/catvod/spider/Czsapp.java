...
public class Czsapp extends Spider {
    protected String siteurl = "https://www.czspp.net";
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        try {
            ...
            Document doc = Jsoup.parse(OkHttpUtil.string(siteurl + "/" + str + "/page/" + str2, Headers()));
    ...
    public String detailContent(List<String> list) {
        ...
        try {
            ...
            JSONArray jSONArray = new JSONArray();
            JSONObject jSONObject2 = new JSONObject();
            Document doc = Jsoup.parse(OkHttpUtil.string(siteurl + "/movie/" + list.get(0) + ".html", Headers()));
    ...
    public String playerContent(String str, String str2, List<String> list) {
        ...
        Elements G8;
        try {
            String K2 = OkHttpUtil.string(siteurl + "/v_play/" + str2 + ".html", Headers());
...
//                    }
                    ...
                    Matcher matcher7 = fi.matcher(K3);
                    if (!matcher7.find()) {
                        return "";
                    }
...
//                    Matcher matcher8 = X.matcher(K4);
//                    if (!matcher8.find()) {
//                        return "";
//                    }
                    String group4 = matcher7.group(1);
                    byte[] bytes3 = group3.getBytes();
                    byte[] bytes4 = "ash3omcjsoajh1ur".getBytes();
                    Cipher cipher2 = Cipher.getInstance("AES/CBC/NoPadding");
                    cipher2.init(1, new SecretKeySpec(bytes3, "AES"), new IvParameterSpec(bytes4));
                    String encodeToString = Base64.encodeToString(cipher2.doFinal(group3.getBytes()), 0);
                    OKCallBack.OKCallBackDefault callBack = new OKCallBack.OKCallBackDefault() {
                    ...
                    hashMap.put("url", group2);
                    hashMap.put("time", group);
                    hashMap.put("ua", group4);
                    //                  hashMap.put("cip", group7);
                    hashMap.put("vkey", encodeToString);
                    //                  hashMap.put("fvkey", encodeToString);
                    OkHttpUtil.post(OkHttpUtil.defaultClient(), "https://jx.xmflv.com/favicon.ico", hashMap, Headers(), callBack);
    ...
    public String searchContent(String str, boolean z) {
        try {
            JSONObject jSONObject = new JSONObject();
            Elements jS = Jsoup.parse(OkHttpUtil.string(siteurl + "/xssearch?s=" + URLEncoder.encode(str), Headers())).select("div.mi_ne_kd > ul > li");
            SpiderDebug.log(jS.toString());
            JSONArray jSONArray = new JSONArray();
            for (Element next : jS) {
